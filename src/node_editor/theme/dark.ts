...
const darkTheme: Theme = {
    node: {
        selected: {
            boxShadow: "0px 0px 0px 2px hsl(var(--pf))",
...
function darkThemeBuildBackgroundStyle(panZoomInfo: PanZoomModel): CSS.Properties {
    ...
    return {
        ...
        backgroundImage: `linear-gradient(hsl(var(--b3)) ${size}px, transparent ${size}px), linear-gradient(to right, hsl(var(--b3)) ${size}px, transparent ${size}px)`
    };
}
