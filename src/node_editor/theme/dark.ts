...
const darkTheme: Theme = {
    node: {
        selected: {
            boxShadow: "0px 0px 4px 4px var(--color-accent)",
...
function darkThemeBuildBackgroundStyle(panZoomInfo: PanZoomModel): CSS.Properties {
    ...
    return {
        ...
        backgroundImage: `linear-gradient(var(--color-base-300) ${size}px, transparent ${size}px), linear-gradient(to right, var(--color-base-300) ${size}px, transparent ${size}px)`
    };
}
